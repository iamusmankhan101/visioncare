...
const LensCategoriesSection = styled.div`
  margin-bottom: 3rem;
  padding: 2rem;
  background: #f8fafc;
  border-radius: 16px;
    ...
    <PageContainer>
      ...
      <MainContent>
          <LensCategoriesSection>
            <CategoriesTitle>Lens Categories</CategoriesTitle>
            <CategoriesSubtitle>Discover our premium range of contact and prescription lenses</CategoriesSubtitle>
            
            <CategoriesGrid>
              <CategoryCard onClick={() => handleCategoryChange('colored-lenses')}>
                <CategoryImage>
                  <img src="https://images.unsplash.com/photo-1574258495973-f010dfbb5371?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Colored Lenses" />
                </CategoryImage>
                <CategoryInfo>
                  <CategoryTitle>Colored Lenses</CategoryTitle>
                  <CategoryDescription>Transform your look with natural-looking colored contact lenses</CategoryDescription>
                  <CategoryFeatures>
                  ...
                  <ColorSwatches>
                    <ColorSwatch color="#8B4513" />
                    <ColorSwatch color="#4169E1" />
                    <ColorSwatch color="#228B22" />
                    <ColorSwatch color="#CD853F" />
                    <ColorSwatch color="#9932CC" />
                  </ColorSwatches>
                </CategoryInfo>
              </CategoryCard>
              
              <CategoryCard onClick={() => handleCategoryChange('transparent-lenses')}>
                <CategoryImage>
                  <img src="https://images.unsplash.com/photo-1559056199-641a0ac8b55e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Transparent Lenses" />
                </CategoryImage>
                <CategoryInfo>
                  <CategoryTitle>Transparent Lenses</CategoryTitle>
                  <CategoryDescription>Crystal clear vision correction without changing your natural eye color</CategoryDescription>
                  <CategoryFeatures>
                    <FeatureIcon>👁️</FeatureIcon>
                    <FeatureIcon>🛡️</FeatureIcon>
                    <FeatureIcon>🎯</FeatureIcon>
              ...
              <CategoryCard onClick={() => handleCategoryChange('contact-lenses')}>
                <CategoryImage>
                  <img src="https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Contact Lenses" />
                </CategoryImage>
                <CategoryInfo>
                  <CategoryTitle>Contact Lenses</CategoryTitle>
                  <CategoryDescription>Premium contact lenses for all-day comfort and clear vision</CategoryDescription>
                  <CategoryFeatures>
                    <FeatureIcon>👁️</FeatureIcon>
                    <FeatureIcon>🛡️</FeatureIcon>
                    <FeatureIcon>🎯</FeatureIcon>
              ...
              <CategoryCard onClick={() => handleCategoryChange('prescription-lenses')}>
                <CategoryImage>
                  <img src="https://images.unsplash.com/photo-1509695507497-903c140c43b0?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Prescription Lenses" />
                </CategoryImage>
                <CategoryInfo>
                  <CategoryTitle>Prescription Lenses</CategoryTitle>
                  <CategoryDescription>Custom prescription solutions for all vision correction needs</CategoryDescription>
                  <CategoryFeatures>
                    <FeatureIcon>👁️</FeatureIcon>
                    <FeatureIcon>🛡️</FeatureIcon>
                    <FeatureIcon>🎯</FeatureIcon>
